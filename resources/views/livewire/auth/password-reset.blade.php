<div class="min-h-screen flex items-center justify-center bg-[#9966CC]/15">
    <div class="bg-white w-[360px] p-8 rounded-xl border border-gray-300 shadow-sm">
        ...
        <form wire:submit.prevent="resetPassword">
            <div class="mb-4">
                <input wire:model.defer="password" type="password" placeholder="Password Baru *"
            ...
            <div class="mb-4">
                <input wire:model.defer="password_confirmation" type="password" placeholder="Konfirmasi Password *"
                       class="w-full px-4 py-2 border rounded-full focus:outline-none focus:border-gray-400">
            </div>
